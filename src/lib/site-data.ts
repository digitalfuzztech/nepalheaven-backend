...
export const experienceCategories = [
  { name: "Adventure", detail: "Peaks, rivers and thermals for travellers who need the adrenaline.", image: expParagliding, count: 24 },
  { name: "Luxury Tours", detail: "Palace hotels, private guides and helicopter mornings.", image: ctaLodge, count: 12 },
  { name: "Culture", detail: "Newari courtyards, festivals and living heritage.", image: destKathmandu, count: 18 },
  { name: "Wellness", detail: "Himalayan yoga retreats, silence and hot springs.", image: destPokhara, count: 9 },
  { name: "Photography", detail: "Small groups led by published Himalayan photographers.", image: destMustang, count: 7 },
  { name: "Pilgrimage", detail: "Lumbini, Muktinath and Pashupatinath with scholar guides.", image: destLumbini, count: 11 },
  { name: "Food Tours", detail: "Momo workshops, spice markets and Newari feasts.", image: destBandipur, count: 6 },
  { name: "Family Trips", detail: "Gentle itineraries built around younger travellers.", image: destChitwan, count: 14 },
  { name: "Honeymoon", detail: "Private lake villas and candlelit mountain terraces.", image: destRara, count: 8 },
];
